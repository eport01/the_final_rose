...
ActiveRecord::Schema.define(version: 2022_11_07_001309) do
  ...
  create_table "outings", force: :cascade do |t|
    ...
    t.string "location"
    t.datetime "date"
    t.index ["bachelorette_id"], name: "index_outings_on_bachelorette_id"
  ...
  add_foreign_key "outings", "bachelorettes"
